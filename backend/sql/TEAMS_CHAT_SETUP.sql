-- ===========================================
-- TEAMS CHAT DATABASE SETUP FOR SUPABASE
-- ===========================================
-- Copy and paste this into your Supabase SQL Editor
-- https://app.supabase.io/project/your-project-id/sql
...
DROP POLICY IF EXISTS "Authenticated users can create threads" ON chat_threads;
...
DROP POLICY IF EXISTS "Users can react to accessible messages" ON message_reactions;
...
DROP TRIGGER IF EXISTS update_thread_activity_trigger ON chat_messages;
...
-- Drop trigger if exists, then create
DROP TRIGGER IF EXISTS update_user_presence_trigger ON chat_messages;
...
-- 
-- Next steps:
-- 1. Make sure your auth.users table has some test users
-- 2. Start the backend server: npm run dev
-- 3. Open the frontend and click Teams
